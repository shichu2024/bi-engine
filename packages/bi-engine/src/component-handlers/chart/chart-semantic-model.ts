 ...
 * 仅反映第一阶段支持的类型。
 */
export type SeriesKind = 'line' | 'bar' | 'pie' | 'scatter' | 'radar' | 'candlestick' | 'gauge' | 'combo';
...
import type { NormalizedChartComponent } from './chart-normalizer';
